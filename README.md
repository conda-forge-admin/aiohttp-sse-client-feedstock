About aiohttp-sse-client-feedstock
==================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/aiohttp-sse-client-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/aiohttp-sse-client-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add aiohttp-sse-client
# for installing globally
pixi global install aiohttp-sse-client
```
...
It is possible to list all of the versions of `aiohttp-sse-client` available on your platform:
...
```
pixi search aiohttp-sse-client --channel conda-forge
```
